...
let apuntes = [
  {
    ...
    contenido: 'Una Progressive Web App combina lo mejor de la web y las apps nativas: instalable, offline-first y con acceso a recursos del dispositivo.',
  ...
  },
  {
    ...
    contenido: 'Temas: series de Taylor, integrales dobles y triples. Llevar calculadora.',
    materia: 'Cálculo III',
...
router.post('/', (req, res) => {
  ...
  apuntes.unshift(apunte); // más reciente primero
